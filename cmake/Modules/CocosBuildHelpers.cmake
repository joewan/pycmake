...
if (${CMAKE_SYSTEM_NAME} MATCHES "Windows")
  if(WINRT)
    set(PYCM_SYSTEM_STRING "Windows RT")
  elseif(WP8)
    set(PYCM_SYSTEM_STRING "Windows Phone 8")
  else()
    set(WINDOWS TRUE)
    set(PYCM_SYSTEM_STRING "Windows Desktop")
  endif()
elseif (${CMAKE_SYSTEM_NAME} MATCHES "Linux")
  if(ANDROID)
    set(PYCM_SYSTEM_STRING "Android")
  else()
    set(LINUX TRUE)
    set(PYCM_SYSTEM_STRING "Linux")
  endif()
elseif (${CMAKE_SYSTEM_NAME} MATCHES "Darwin")
  if(IOS)
    set(PYCM_SYSTEM_STRING "IOS")
  else()
    set(MACOSX TRUE)
    set(APPLE TRUE)
    set(PYCM_SYSTEM_STRING "Mac OSX")
  endif()
endif()
...
if(CMAKE_CROSSCOMPILING)
  set(BUILDING_STRING "It appears you are cross compiling for ${PYCM_SYSTEM_STRING} with ${COMPILER_STRING}")
else()
  set(BUILDING_STRING "It appears you are builing natively for ${PYCM_SYSTEM_STRING} with ${COMPILER_STRING}")
endif()
