...
#include "FrameProfiler/FrameProfiler.h"
...
ColorF profile_colors[] =
{
	...
	// Do not add any other labels - color lookup is defined as byte
		...
		#include <FrameProfiler/FrameProfiler_impl.pc.h>
	#elif CRY_PLATFORM_DURANGO
		#include <FrameProfiler/FrameProfiler_impl.durango.h>
	#elif CRY_PLATFORM_ORBIS
		#include <FrameProfiler/FrameProfiler_impl.orbis.h>
	#else
