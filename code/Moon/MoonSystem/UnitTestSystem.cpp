...
#include "StringUtils.h"    // cry_strXXX()
#include "CryCustomTypes.h" // CRY_ARRAY_COUNT
...
void CUnitTestManager::StartTesting( UnitTestRunContext &context, CryUnitTest::TReporterToUse reporterToUse )
{
	...
	{
	case ExcelReporter:   context.pReporter = new CUnitTestExcelReporter;
		break;
	case MinimalReporter:   context.pReporter = new CMinimalLogUnitTestReporter;
		break;
	case RegularReporter:   context.pReporter = new CLogUnitTestReporter;
		break;
	default:
		assert(0);
	}
