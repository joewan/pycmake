...
class COculusController:public IHmdController
{
	...
	unsigned int  m_controllerEnumMap[eHmdController_MaxNumOculusControllers]; // maps CryEngine controller enum to Oculus controller enum
...
#endif                                                                       // #ifdef INCLUDE_OCULUS_SDK
