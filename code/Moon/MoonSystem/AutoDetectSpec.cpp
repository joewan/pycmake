...
void Win32SysInspect::GetOS(SPlatformInfo::EWinVersion &ver, bool &is64Bit, char* pName, size_t bufferSize)
{
	...
	if (RtlGetVersion && RtlGetVersion(&sysInfo) == 0)
	{
		...
		if (pName && bufferSize)
		{
			...
			switch (ver)
			{
			case SPlatformInfo::Win2000:    windowsVersionText = "Windows 2000";
				break;
			case SPlatformInfo::WinXP:      windowsVersionText = "Windows XP";
				break;
			case SPlatformInfo::WinSrv2003: windowsVersionText = "Windows Server 2003";
				break;
			case SPlatformInfo::WinVista:   windowsVersionText = "Windows Vista";
				break;
			case SPlatformInfo::Win7:       windowsVersionText = "Windows 7";
				break;
			case SPlatformInfo::Win8:       windowsVersionText = "Windows 8";
				break;
			case SPlatformInfo::Win8Point1: windowsVersionText = "Windows 8.1";
				break;
			case SPlatformInfo::Win10:      windowsVersionText = "Windows 10";
				break;
			default:                        windowsVersionText = "Windows";
				break;
			}
