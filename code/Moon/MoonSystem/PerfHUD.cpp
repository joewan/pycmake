...
void CRenderStatsWidget::Update()
{
	...
	{
	case eRT_OpenGL: pRenderType = "PC - OpenGL";
		break;
	case eRT_DX11: pRenderType = "PC - DX11";
		break;
	case eRT_DX12: pRenderType = "PC - DX12";
		break;
	case eRT_XboxOne: pRenderType = "Xbox One";
		break;
	case eRT_PS4: pRenderType = "PS4";
		break;
	case eRT_Null: pRenderType = "Null";
		break;
	case eRT_Undefined:
	default: assert(0);
