...
class CSystem:public ISystem, public ILoadConfigurationEntrySink, public ISystemEventListener, public IWindowMessageHandler
{
	...
	virtual IFlashPlayer*             CreateFlashPlayerInstance() const override;
	virtual IFlashPlayerBootStrapper* CreateFlashPlayerBootStrapper() const override;
	virtual void                      SetFlashLoadMovieHandler(IFlashLoadMovieHandler* pHandler) const override;
	virtual void                      GetFlashProfileResults(float &accumTime, bool reset) const override;
	virtual void                      ResetFlashMeshCache() const override;
	virtual void                      GFxAmpEnable(bool bEnable) override;
	virtual void                      GFxAmpAdvanceFrame() override;
