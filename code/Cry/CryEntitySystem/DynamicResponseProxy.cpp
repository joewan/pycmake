...
{
	m_pResponseActor->QueueSignal(pSignalName, pSignalContext, delayBeforeFiring);
}

//////////////////////////////////////////////////////////////////////////
DRS::IVariableCollection* CDynamicResponseProxy::GetLocalVariableCollection() const
{
	CRY_ASSERT_MESSAGE(m_pResponseActor, "DRS Proxy without Actor detected. Should never happen.");
