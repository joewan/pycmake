...
CEntityAudioProxy::CEntityAudioProxy()
	...
	, m_lastSetEnvironmentAmount(0.0f)
{}
...
//////////////////////////////////////////////////////////////////////////
void CEntityAudioProxy::OnMoveNear(IEntity const* const __restrict pINearMovingEntity, float const environmentAmount)
{
	...
	IEntityAudioProxy* const pIEntityAudioProxy = static_cast<IEntityAudioProxy*>(pINearMovingEntity->GetProxy(ENTITY_PROXY_AUDIO));

	if (pIEntityAudioProxy != nullptr && (fabs_tpl(m_lastSetEnvironmentAmount - environmentAmount) > FLT_EPSILON))
	{
		CRY_ASSERT(environmentAmount >= 0.0f && environmentAmount <= 1.0f);
		pIEntityAudioProxy->SetEnvironmentAmount(m_audioEnvironmentId, environmentAmount, INVALID_AUDIO_PROXY_ID);
		m_lastSetEnvironmentAmount = environmentAmount;
	}
}
...
void CEntityAudioProxy::OnAreaCrossing(IEntity const* const pIEntity)
{
	...
	{
		pIEntityAudioProxy->SetEnvironmentAmount(m_audioEnvironmentId, 1.0f, INVALID_AUDIO_PROXY_ID);
	}
}
...
//////////////////////////////////////////////////////////////////////////
void CEntityAudioProxy::SetEnvironmentAmountInternal(IEntity const* const pEntity, float const amount) const
{
