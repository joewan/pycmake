...
void CFlashPlayer::SetViewScaleMode(EScaleModeType scaleMode)
{
	...
	if (m_pMovieView)
	{
		...
		switch (scaleMode)
		{
		case eSM_NoScale:   sm = GFxMovieView::SM_NoScale;
			break;
		case eSM_ShowAll:   sm = GFxMovieView::SM_ShowAll;
			break;
		case eSM_ExactFit:  sm = GFxMovieView::SM_ExactFit;
			break;
		case eSM_NoBorder:  sm = GFxMovieView::SM_NoBorder;
			break;
		default: assert(0);
...
IFlashPlayer::EScaleModeType CFlashPlayer::GetViewScaleMode() const
{
	...
	if (m_pMovieView)
	{
		...
		switch (sm)
		{
		case GFxMovieView::SM_NoScale:  scaleMode = eSM_NoScale;
			break;
		case GFxMovieView::SM_ShowAll:  scaleMode = eSM_ShowAll;
			break;
		case GFxMovieView::SM_ExactFit: scaleMode = eSM_ExactFit;
			break;
		case GFxMovieView::SM_NoBorder: scaleMode = eSM_NoBorder;
			break;
		default: assert(0);
...
void CFlashPlayer::SetViewAlignment(EAlignType viewAlignment)
{
	...
	if (m_pMovieView)
	{
		...
		{
		case eAT_Center:        va = GFxMovieView::Align_Center;
			break;
		case eAT_TopCenter:     va = GFxMovieView::Align_TopCenter;
			break;
		case eAT_BottomCenter:  va = GFxMovieView::Align_BottomCenter;
			break;
		case eAT_CenterLeft:    va = GFxMovieView::Align_CenterLeft;
			break;
		case eAT_CenterRight:   va = GFxMovieView::Align_CenterRight;
			break;
		case eAT_TopLeft:       va = GFxMovieView::Align_TopLeft;
			break;
		case eAT_TopRight:      va = GFxMovieView::Align_TopRight;
			break;
		case eAT_BottomLeft:    va = GFxMovieView::Align_BottomLeft;
			break;
		case eAT_BottomRight:   va = GFxMovieView::Align_BottomRight;
			break;
		default: assert(0);
...
IFlashPlayer::EAlignType CFlashPlayer::GetViewAlignment() const
{
	...
	if (m_pMovieView)
	{
		...
		switch (va)
		{
		case GFxMovieView::Align_Center:       viewAlignment = eAT_Center;
			break;
		case GFxMovieView::Align_TopCenter:    viewAlignment = eAT_TopCenter;
			break;
		case GFxMovieView::Align_BottomCenter: viewAlignment = eAT_BottomCenter;
			break;
		case GFxMovieView::Align_CenterLeft:   viewAlignment = eAT_CenterLeft;
			break;
		case GFxMovieView::Align_CenterRight:  viewAlignment = eAT_CenterRight;
			break;
		case GFxMovieView::Align_TopLeft:      viewAlignment = eAT_TopLeft;
			break;
		case GFxMovieView::Align_TopRight:     viewAlignment = eAT_TopRight;
			break;
		case GFxMovieView::Align_BottomLeft:   viewAlignment = eAT_BottomLeft;
			break;
		case GFxMovieView::Align_BottomRight:  viewAlignment = eAT_BottomRight;
			break;
		default: assert(0);
...
#if !defined(RELEASE)
void CSystem::GetFlashRenderStats(unsigned &numDPs, unsigned int &numTris)
{
	numDPs  = 0;
	numTris = 0;
...
void CSystem::GFxAmpEnable(bool bEnable)
{
#if defined(GFX_AMP_SERVER)
...
void CSystem::GFxAmpAdvanceFrame()
{
#if defined(GFX_AMP_SERVER)
