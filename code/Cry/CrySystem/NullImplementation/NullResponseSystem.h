...
#include <IDynamicResponseAction.h>
#include <IDynamicResponseCondition.h>
...
class CResponseActor final:public DRS::IResponseActor
{
	...
	virtual void                            QueueSignal(const CHashedString &signalName, DRS::IVariableCollectionSharedPtr pSignalContext = nullptr, float delayBeforeFiring = 0.0f) override {}
	//////////////////////////////////////////////////////////
...
struct CSystem final:public DRS::IDynamicResponseSystem
{
	...
	virtual void                                     CancelSignalProcessing(const CHashedString &signalName, DRS::IResponseActor* pSender, float delayBeforeCancel = 0.0f) override {}
