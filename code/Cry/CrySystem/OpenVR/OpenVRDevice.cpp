...
const HmdTrackingState & Device::GetLocalTrackingState() const
{
	...
	{
		gEnv->pLog->LogError("[HMD][OpenVR] Device::GetTrackingState() should be called from main thread only!");
		//__debugbreak(); <-- SKYHARBOR
	}
	#endif
	if (m_hmdTrackingDisabled)
	{
		return m_disabledTrackingState;
	}
	return m_localStates[vr::k_unTrackedDeviceIndex_Hmd];
}
...
const HmdTrackingState & Device::GetNativeTrackingState() const
{
	...
	return m_nativeStates[vr::k_unTrackedDeviceIndex_Hmd];
}
...
void Device::OnSetupEyeTargets(ERenderAPI api, ERenderColorSpace colorSpace, void* leftEyeHandle, void* rightEyeHandle)
{
	...
	switch (colorSpace)
	{
	case CryVR::OpenVR::ERenderColorSpace::eRenderColorSpace_Auto: m_eyeTargets[EEyeType::eEyeType_LeftEye]->eColorSpace = m_eyeTargets[EEyeType::eEyeType_RightEye]->eColorSpace = vr::EColorSpace::ColorSpace_Auto;
		break;
	case CryVR::OpenVR::ERenderColorSpace::eRenderColorSpace_Gamma: m_eyeTargets[EEyeType::eEyeType_LeftEye]->eColorSpace = m_eyeTargets[EEyeType::eEyeType_RightEye]->eColorSpace = vr::EColorSpace::ColorSpace_Gamma;
		break;
	case CryVR::OpenVR::ERenderColorSpace::eRenderColorSpace_Linear: m_eyeTargets[EEyeType::eEyeType_LeftEye]->eColorSpace = m_eyeTargets[EEyeType::eEyeType_RightEye]->eColorSpace = vr::EColorSpace::ColorSpace_Linear;
		break;
	default: m_eyeTargets[EEyeType::eEyeType_LeftEye]->eColorSpace = m_eyeTargets[EEyeType::eEyeType_RightEye]->eColorSpace = vr::EColorSpace::ColorSpace_Auto;
		break;
	}

	switch (api)
	{
	case CryVR::OpenVR::ERenderAPI::eRenderAPI_DirectX: m_eyeTargets[EEyeType::eEyeType_LeftEye]->eType = m_eyeTargets[EEyeType::eEyeType_RightEye]->eType = vr::EGraphicsAPIConvention::API_DirectX;
		break;
	case CryVR::OpenVR::ERenderAPI::eRenderAPI_OpenGL: m_eyeTargets[EEyeType::eEyeType_LeftEye]->eType = m_eyeTargets[EEyeType::eEyeType_RightEye]->eType = vr::EGraphicsAPIConvention::API_OpenGL;
		break;
	default: m_eyeTargets[EEyeType::eEyeType_LeftEye]->eType = m_eyeTargets[EEyeType::eEyeType_RightEye]->eType = vr::EGraphicsAPIConvention::API_DirectX;
		break;
	}
...
void Device::OnSetupOverlay(int id, ERenderAPI api, ERenderColorSpace colorSpace, void* overlayTextureHandle)
{
	...
	switch (api)
	{
	case CryVR::OpenVR::ERenderAPI::eRenderAPI_DirectX: m_overlays[id].vrTexture->eType = vr::EGraphicsAPIConvention::API_DirectX;
		break;
	case CryVR::OpenVR::ERenderAPI::eRenderAPI_OpenGL: m_overlays[id].vrTexture->eType = vr::EGraphicsAPIConvention::API_OpenGL;
		break;
	default: m_overlays[id].vrTexture->eType = vr::EGraphicsAPIConvention::API_DirectX;
		break;
	}
	switch (colorSpace)
	{
	case CryVR::OpenVR::ERenderColorSpace::eRenderColorSpace_Auto: m_overlays[id].vrTexture->eColorSpace = vr::EColorSpace::ColorSpace_Auto;
		break;
	case CryVR::OpenVR::ERenderColorSpace::eRenderColorSpace_Gamma: m_overlays[id].vrTexture->eColorSpace = vr::EColorSpace::ColorSpace_Gamma;
		break;
	case CryVR::OpenVR::ERenderColorSpace::eRenderColorSpace_Linear: m_overlays[id].vrTexture->eColorSpace = vr::EColorSpace::ColorSpace_Linear;
		break;
	default: m_overlays[id].vrTexture->eColorSpace = vr::EColorSpace::ColorSpace_Auto;
		break;
	}
