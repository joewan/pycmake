...
#include "FrameProfiler/FrameProfiler_JobSystem.h"
...
bool CCryAction::SaveGame( const char* path, bool bQuick, bool bForceImmediate, ESaveGameReason reason, bool ignoreDelay, const char* checkPointName)
{
	...
	if (bForceImmediate)
	{
		...
		if (gEnv->pStatoscope)
		{
			...
			switch (reason)
			{
			case eSGR_Command: s = "Command";
				break;
			case eSGR_FlowGraph: s = "FlowGraph";
				break;
			case eSGR_LevelStart: s = "LevelStart";
				break;
			case eSGR_QuickSave: s = "QuickSave";
				break;
			default: s = "Unknown Reason";
				break;
			}
