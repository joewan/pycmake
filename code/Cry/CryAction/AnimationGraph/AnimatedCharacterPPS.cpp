...
QuatT CAnimatedCharacter::CalculateWantedEntityMovement(const QuatT &desiredAnimMovement) const
{
	...
	if (DebugVelocitiesEnabled())
	{
		...
		switch (mcmh)
		{
		case eMCM_Entity: szMcmH = "ENT";
			break;
		case eMCM_ClampedEntity: szMcmH = "ENT_CL";
			break;
		case eMCM_SmoothedEntity: szMcmH = "ENT_SM";
			break;
		case eMCM_DecoupledCatchUp: szMcmH = "DEC";
			break;
		case eMCM_Animation: szMcmH = "ANM";
			break;
		case eMCM_AnimationHCollision: szMcmH = "ANM_HC";
			break;
		}
		char* szMcmV = "???";
		switch (mcmv)
		{
		case eMCM_Entity: szMcmV = "ENT";
			break;
		case eMCM_ClampedEntity: szMcmV = "ENT_CL";
			break;
		case eMCM_SmoothedEntity: szMcmV = "ENT_SM";
			break;
		case eMCM_DecoupledCatchUp: szMcmV = "DEC";
			break;
		case eMCM_Animation: szMcmV = "ANM";
			break;
		case eMCM_AnimationHCollision: szMcmV = "ANM_HC";
			break;
		}
