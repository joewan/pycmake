...
void CFlashUIElement::UpdateViewPort()
{
	...
	else if (m_constraints.eType == SUIConstraints::ePT_Dynamic)
	{
		if (m_constraints.bScale)
		{
			...
			{
			default:
			case SUIConstraints::ePA_Lower:  posX = 0;
				break;
			case SUIConstraints::ePA_Mid: posX = fitToHeight ? (int) ((dx - dy * hudAspectRatio) / 2.f) : 0;
				break;
			case SUIConstraints::ePA_Upper: posX = fitToHeight ? (int) (dx - dy * hudAspectRatio) : 0;
				break;
			}
			switch (m_constraints.eVAlign)
			{
			default:
			case SUIConstraints::ePA_Lower: posY = 0;
				break;
			case SUIConstraints::ePA_Mid: posY = !fitToHeight ? (int) ((dy - dx / hudAspectRatio) / 2.f) : 0;
				break;
			case SUIConstraints::ePA_Upper: posY = !fitToHeight ? (int) (dy - dx / hudAspectRatio) : 0;
				break;
			}
		...
		else
		{
			...
			case SUIConstraints::ePA_Lower: posX = 0;
				break;
			case SUIConstraints::ePA_Mid: posX = (dx - width) / 2;
				break;
			case SUIConstraints::ePA_Upper: posX =  dx - width;
				break;
			}
			switch (m_constraints.eVAlign)
			{
			...
			case SUIConstraints::ePA_Lower: posY = 0;
				break;
			case SUIConstraints::ePA_Mid: posY = (dy - height) / 2;
				break;
			case SUIConstraints::ePA_Upper: posY = dy - height;
				break;
			}
