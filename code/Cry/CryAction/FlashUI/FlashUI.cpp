...
TUIEventSystemMap* CFlashUI::GetEventSystemMap( IUIEventSystem::EEventSystemType eType )
{
	...
	switch (eType)
	{
	case IUIEventSystem::eEST_SYSTEM_TO_UI: pMap = &m_eventSystemsSysToUi;
		break;
	case IUIEventSystem::eEST_UI_TO_SYSTEM: pMap = &m_eventSystemsUiToSys;
		break;
...
SFlashKeyEvent CFlashUI::MapToFlashKeyEvent(const SInputEvent &inputEvent)
{
	...
	switch (keyId)
	{
	case eKI_Backspace: keyCode = SFlashKeyEvent::Backspace;
		break;
	case eKI_Tab:       keyCode = SFlashKeyEvent::Tab;
		break;
	case eKI_Enter:     keyCode = SFlashKeyEvent::Return;
		break;
	case eKI_LShift:
	case eKI_RShift:    keyCode = SFlashKeyEvent::Shift;
		break;
	case eKI_LCtrl:
	case eKI_RCtrl:     keyCode = SFlashKeyEvent::Control;
		break;
	case eKI_LAlt:
	case eKI_RAlt:      keyCode = SFlashKeyEvent::Alt;
		break;
	case eKI_Escape:    keyCode = SFlashKeyEvent::Escape;
		break;
	case eKI_PgUp:      keyCode = SFlashKeyEvent::PageUp;
		break;
	case eKI_PgDn:      keyCode = SFlashKeyEvent::PageDown;
		break;
	case eKI_End:       keyCode = SFlashKeyEvent::End;
		break;
	case eKI_Home:      keyCode = SFlashKeyEvent::Home;
		break;
	case eKI_Left:      keyCode = SFlashKeyEvent::Left;
		break;
	case eKI_Up:        keyCode = SFlashKeyEvent::Up;
		break;
	case eKI_Right:     keyCode = SFlashKeyEvent::Right;
		break;
	case eKI_Down:      keyCode = SFlashKeyEvent::Down;
		break;
	case eKI_Insert:    keyCode = SFlashKeyEvent::Insert;
		break;
	case eKI_Delete:    keyCode = SFlashKeyEvent::Delete;
		break;
	}
