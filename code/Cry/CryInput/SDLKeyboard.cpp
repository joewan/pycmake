...
unsigned char CSDLKeyboard::Event2ASCII(const SInputEvent &event)
{
	...
	switch (keySym)
	{
	case SDLK_BACKSPACE: ascii = '\b';
		break;
	case SDLK_TAB: ascii = '\t';
		break;
	case SDLK_RETURN: ascii = '\r';
		break;
	case SDLK_ESCAPE: ascii = '\x1b';
		break;
	case SDLK_SPACE: ascii = ' ';
		break;
	case SDLK_EXCLAIM: ascii = '!';
		break;
	case SDLK_QUOTEDBL: ascii = '"';
		break;
	case SDLK_HASH: ascii = '#';
		break;
	case SDLK_DOLLAR: ascii = '$';
		break;
	case SDLK_AMPERSAND: ascii = '&';
		break;
	case SDLK_QUOTE: ascii = '\'';
		break;
	case SDLK_LEFTPAREN: ascii = '(';
		break;
	case SDLK_RIGHTPAREN: ascii = ')';
		break;
	case SDLK_ASTERISK: ascii = '*';
		break;
	case SDLK_PLUS: ascii = '+';
		break;
	case SDLK_COMMA: ascii = ',';
		break;
	case SDLK_MINUS: ascii = '-';
		break;
	case SDLK_PERIOD: ascii = '.';
		break;
	case SDLK_SLASH: ascii = '/';
		break;
	case SDLK_0: ascii = '0';
		break;
	case SDLK_1: ascii = '1';
	...
	case SDLK_9: ascii = '9';
		break;
	case SDLK_COLON: ascii = ':';
		break;
	case SDLK_SEMICOLON: ascii = ';';
		break;
	case SDLK_LESS: ascii = '<';
		break;
	case SDLK_EQUALS: ascii = '=';
		break;
	case SDLK_GREATER: ascii = '>';
		break;
	case SDLK_QUESTION: ascii = '?';
		break;
	case SDLK_AT: ascii = '@';
		break;
	case SDLK_LEFTBRACKET: ascii = '[';
		break;
	case SDLK_BACKSLASH: ascii = '\\';
		break;
	case SDLK_RIGHTBRACKET: ascii = ']';
		break;
	case SDLK_CARET: ascii = '^';
		break;
	case SDLK_UNDERSCORE: ascii = '_';
		break;
	case SDLK_BACKQUOTE: ascii = '`';
		break;
	case SDLK_a: ascii = 'a';
		alpha            = true;
		break;
	...
	case SDLK_z: ascii = 'z';
		alpha            = true;
		break;
	case SDLK_DELETE: ascii = '\x7f';
		break;
	case SDLK_KP_0: ascii = '0';
		break;
	case SDLK_KP_1: ascii = '1';
		break;
	case SDLK_KP_2: ascii = '2';
		break;
	case SDLK_KP_3: ascii = '3';
		break;
	case SDLK_KP_4: ascii = '4';
		break;
	case SDLK_KP_5: ascii = '5';
		break;
	case SDLK_KP_6: ascii = '6';
		break;
	case SDLK_KP_7: ascii = '7';
		break;
	case SDLK_KP_8: ascii = '8';
		break;
	case SDLK_KP_9: ascii = '9';
		break;
	case SDLK_KP_PERIOD: ascii = '.';
		break;
	case SDLK_KP_DIVIDE: ascii = '/';
		break;
	case SDLK_KP_MULTIPLY: ascii = '*';
		break;
	case SDLK_KP_MINUS: ascii = '-';
		break;
	case SDLK_KP_PLUS: ascii = '+';
		break;
	case SDLK_KP_ENTER: ascii = '\r';
		break;
	case SDLK_KP_EQUALS: ascii = '=';
		break;
	default: ascii = 0;
		break;
	}
