...
#include <Serialization/IntrusiveFactory.h>
...
/** SSoundKey used in sound track.
 */
struct SSoundKey:public STrackDurationKey
{
	SSoundKey() : STrackDurationKey()
	{
		m_startTrigger[0] = 0;
		m_stopTrigger[0]  = 0;
	}

	static const char* GetType()              { return "Sound"; }
