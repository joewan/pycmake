...
// Uncrustify cannot parse this type of statement within a templated definition.
#define FIRST_IS_SMALLER(A, B) ((A) < (B))
...
template<size_t Length, size_t Align = TARGET_DEFAULT_ALIGN, bool bFallback = FIRST_IS_SMALLER((std::alignment_of<typename std::aligned_storage<Length, Align>::type>::value), Align)>
